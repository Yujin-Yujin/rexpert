...
class FusionArguments:
    ...
    unfreeze_adapter: Optional[bool] = field(
        default=False, metadata={"help": "unfreeze adapter while fusion training"}
    )
...
def main():
    ...
    if (fusion_args.train_fusion + fusion_args.test_fusion) >0:
        ...
        if fusion_args.train_fusion:
            ...
            model.train_fusion(adapter_names, unfreeze_adapters=fusion_args.unfreeze_adapter)
        else:
    ...
    if fusion_args.test_fusion:
        ...
        trainer = Trainer(
            ...
            do_save_adapters=fusion_args.unfreeze_adapter,
