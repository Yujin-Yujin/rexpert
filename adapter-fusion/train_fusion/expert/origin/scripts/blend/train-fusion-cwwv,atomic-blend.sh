...
export DATASET=/home/yujin/rexpert/dataset/blend/10k/cwwv,atomic
export PRETRAINED_ADAPTER_DIR_PATH=/home/yujin/rexpert/output/best/adapters/full
export OUTPUT_DIR=/home/yujin/rexpert/output/fusions/blend/10k/cwwv,atomic
export BATCH=8
...
python ../../run_multiple_choice.py \
    ...
    --wandb_name "fusion-$ADAPTER_NAMES-10k-cwwv,atomic" \
    --train_fusion \
    --do_train \
    --do_eval \
    --seed 42 \
