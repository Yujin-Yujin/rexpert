...
export OUTPUT_DIR=/home/yujin/rexpert/output/fusions/10k/origin/atomic,cwwv
export BATCH=8
export PRETRAINED_FUSION_PATH=/home/yujin/rexpert/output/fusions/10k/origin/atomic,cwwv
