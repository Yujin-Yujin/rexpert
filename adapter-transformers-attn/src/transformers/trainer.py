...
class Trainer:
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (
                    ...
                    tr_loss += self.training_step(model, inputs, step=step, epoch=epoch)
    ...
    def training_step(self, model: nn.Module, inputs: Dict[str, Union[torch.Tensor, Any]], step=None, epoch=None) -> torch.Tensor:
        """
        ...
        if self.args.fp16 and _use_native_amp:
            ...
            loss = self.compute_loss(model, inputs, step=step, epoch=epoch)
    ...
    def compute_loss(self, model, inputs, step=None, epoch=None):
        """
        How the loss is computed by Trainer. By default, all models return the loss in the first element.

        Subclass and override for customs behavior.
        """
        outputs = model(**inputs, step=step, epoch=epoch)
