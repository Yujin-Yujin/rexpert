...
class KGProcessor(DataProcessor):
    ...
    def _create_examples(self, lines, type):
        ...
        for line in tqdm.tqdm(lines, desc="read kg data"):
            data_raw = json.loads(line.strip("\n"))
            examples.append(
                InputExample(
...
processors = {"race": RaceProcessor, "swag": SwagProcessor, "arc": ArcProcessor, "syn": SynonymProcessor, "siqa":SocialIQAProcessor, "kg":kgProcessor}
