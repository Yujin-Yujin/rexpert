...
def main():
	...
	parser.add_argument('--model_revision', type=str, default='main', help="For distant debugging.")
	parser.add_argument('--use_auth_token', type=bool, default=False, help="For distant debugging.")
