...
from custom.adapters.model_mixin_custom import ModelWithHeadsAdaptersMixin

from custom.adapters.models.bert_custom import (
...
from custom.modeling_utils_custom import (
    PreTrainedModel,
...
class RobertaLayer(BertLayerAdaptersMixin, nn.Module):
    ...
    def forward(
        ...
        **kwargs
        ...
        layer_output, fusion_attention_probs = apply_chunking_to_forward(
        ...
        return outputs, fusion_attention_probs
    ...
    def forward(
        ...
        **kwargs
        ...
        if not return_dict:
            ...
            return result, fusion_attention_probs
...
class RobertaModel(BertModelAdaptersMixin, RobertaPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs
        ...
        encoder_outputs, fusion_attention_probs = self.encoder(
            embedding_output,
