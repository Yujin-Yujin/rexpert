...
export DATASET=/home/yujin/r-expert/dataset/multikg/1to1
export PRETRAINED_ADAPTER_DIR_PATH=/home/yujin/r-expert/output/best/expert/adapters/full
export OUTPUT_DIR=/home/yujin/r-expert/output/expert/fusions/with-1to1
export BATCH=8
...
python ../run_multiple_choice.py \
    ...
    --wandb_name "fusion-$ADAPTER_NAMES-with-1to1" \
    --train_fusion \
    --do_train \
    --do_select \
    --seed 42 \
