...
class LinearFusion(nn.Module):
    ...
    def forward(
        ...
        print("linear_model forward started")
...
def main():
    ...
    linear_model = LinearFusion(config, 
                        ...
                        num_labels=num_labels)
    linear_model.load_state_dict(torch.load("/home/yujin/r-expert/output/expert/fusions/linear-test/atomic,cwwv/pytorch_model.bin"))
    linear_model.eval()
