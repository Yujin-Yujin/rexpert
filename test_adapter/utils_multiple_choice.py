...
class CommonsenseqaProcessor(DataProcessor):
    ...
    def _create_examples(self, lines, type):
        ...
        for line in tqdm.tqdm(lines, desc="read commonsenseqa data"):
            ...
            # print("question", qa['stem'])
            # print("contexts", qa['question_concept'])
            # print("endings", [item['text'] for item in qa['choices']])
            # print("label", data_raw['answerKey'])
            ...
            examples.append(
                ...
                question=qa['stem'],  
                contexts=["", "", "", "", ""],
                endings=[item['text'] for item in qa['choices']],
